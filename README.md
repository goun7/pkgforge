...
[![Tests](https://img.shields.io/badge/tests-241%20passed-brightgreen)](tests/)
...
To run the automated test suite (241 tests, requires dev dependencies):
...
Current status: **241 passed, 12 skipped** · **41% line coverage** on `core/` ·
CI gate enforces ≥35%.
