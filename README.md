...
[![Tests](https://img.shields.io/badge/tests-482%20passed-brightgreen)](tests/)
...
To run the automated test suite (482 tests, requires dev dependencies):
...
Current status: **482 passed, 12 skipped** · **50% line coverage** on `core/` ·
CI gate enforces ≥35%.
