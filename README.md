...
[![Tests](https://img.shields.io/badge/tests-567%20passed-brightgreen)](tests/)
...
To run the automated test suite (567 tests, requires dev dependencies):
...
Current status: **567 passed, 12 skipped** · **51% line coverage** on `core/` ·
CI gate enforces ≥35%.
