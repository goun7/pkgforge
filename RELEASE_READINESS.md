...
| Alan | Durum | Kanıt |
|---|---|---|
| Test suit'i | **2522 test: 2517 passed, 5 skipped, 0 failed** | `pytest tests/ -q` (junit) |
| Kapsama | **%99** — 12 772 ifade, 133 eksik (`core/`+`ui/`+`i18n/`) | `--cov-fail-under=99` geçiyor |
...
## Bilinen başarısızlık: yok (local 2522/2522)
