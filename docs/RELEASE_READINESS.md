...
| Metric | Value | Notes |
|--------|-------|-------|
| Test suite | **597 passed, 2 skipped, 0 failed** | PyQt6 present; green |
...
security-clean (bandit 0 High/Medium), and green (597 tests). A broad refactor
...
3. ~~**Coverage 41%**~~ — now **52%** (597 tests). The happy-path risk called out
