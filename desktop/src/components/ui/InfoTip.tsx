...
export function InfoTip({ text }: { text: string }) {
  // Faz 8 (5.3): balonu tetikleyiciye aria-describedby ile bagla.
  const tipId = useId();
  return (
    <span className="group relative inline-flex items-center">
      <Info
        ...
        className="cursor-help rounded text-[var(--text-muted)] hover:text-[var(--text-secondary)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--brand-blue)]"
      />
      <span
        id={tipId}
        role="tooltip"
