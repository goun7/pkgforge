...
import { ShieldCheck, FileSearch, Award, ScrollText, KeyRound, Loader2 } from "lucide-react";
import { call, onEvent } from "../lib/rpc";
import type { SignatureInfo, SbomDocument, QualityReport, Provenance, SigstoreStatus } from "../lib/types";
...
type Tab = "sign" | "sbom" | "quality" | "provenance" | "sigstore";
